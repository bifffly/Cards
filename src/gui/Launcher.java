...
public class Launcher extends Application {
    Button loadButton = new Button("Load deck from file");
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                while (fileNeeded && !hasCanceled) {
                    ...
                    fileChooser.getExtensionFilters().addAll(
                            ...
                            new FileChooser.ExtensionFilter("Deck Objects (*.dobj)", "*.dobj"),
                    ...
                    fileNeeded = (!file.getName().endsWith(".deck") && !file.getName().endsWith(".dobj"));
